...
splitwith(_, [], List1, List2) -> {task_2:reverse(List1), List2};
splitwith(Pred, [Head|Tail], List1, List2) -> 
    case Pred(Head) of
        true -> splitwith(Pred, Tail, [Head | List1], List2);
        false -> splitwith(Pred, [], List1, [Head | Tail])
    end.
